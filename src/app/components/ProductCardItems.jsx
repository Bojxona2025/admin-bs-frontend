...
export default function ProductCardItems({ product }) {
  ...
  return (
    <>
      <div
        className="bg-white rounded-lg shadow-md flex flex-col w-full max-w-[220px] mx-auto relative cursor-pointer hover:shadow-lg transition-shadow h-full min-h-[470px]"
      ...
      >
        ...
        <div className="p-2 mt-auto">
          {/* Rating display from product data */}
