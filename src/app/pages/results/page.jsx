...
const NextArrow = (props) => {
  ...
  return (
    <div
      onClick={onClick}
      className="absolute -right-11 max-[800px]:hidden top-1/2 transform -translate-y-1/2 z-10 cursor-pointer bg-white rounded-full shadow p-2 hover:bg-gray-200 transition max-[1330px]:right-0"
    >
      <ChevronRight />
    </div>
  );
